...
import menu.principal.MenuPrincipal;
...
public class ArvoreMenu {
    ...
    static sql.Lista lsSubCod;
    static sql.Lista lsComp;
    static sql.Lista lsCompCod;
    static sql.Lista lsPte;
    static sql.Lista lsPteCod;
